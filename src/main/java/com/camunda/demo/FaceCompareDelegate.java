...
public class FaceCompareDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.setVariable("faceImage","");
...
//            );
        ...
        if (personalDetails.getSelfieLivelinessScore() != 0) {
            delegateExecution.setVariable("selfieLivenessScore", personalDetails.getSelfieLivelinessScore());
        } else {
        ...
        if(personalDetails.getIdSelfieMatchScore()>0){
            match=personalDetails.getIdSelfieMatchScore();
        }
        else {
