...
@Component
public class SMSHasAvailableAccount implements JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        smsAlertService.sendSMS(mobileNumber, "Dear "+names[0].toUpperCase().charAt(0)+ names[0].substring(1).toLowerCase()+" it seems you already have an account that is active with us for this product. ");
